...
function App() {
    ...
    let [tasks, setTasks] = useState<TasksType>({
        [todolistId1]: {
            data: [
                {id: todolistId1, title: "HTML&CSS1111", isDone: true},
                {id: todolistId2, title: "JS1111", isDone: true}
            ],
            filter: "all"
        },
        [todolistId2]: {
            data: [
                {id: todolistId1, title: "HTML&CSS22222", isDone: true},
                {id: todolistId2, title: "JS2222", isDone: false,}
            ],
    ...
    function addTask(todolistId: string, title: string) {
        let newTask = {id: "todolistId3", title: title, isDone: false};
        setTasks({
            ...tasks, [todolistId]: {
                ...tasks[todolistId],
